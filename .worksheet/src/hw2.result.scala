...
object result {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(72); 
  ...
  val t2 = new NonEmpty(4, t1, new Empty);System.out.println("""t2  : hw2.NonEmpty = """ + $show(t2 ));$skip(33); 

  val result1 = List(1, "2", 3);System.out.println("""result1  : hw2.List.List[Any] = """ + $show(result1 ));$skip(23); 
